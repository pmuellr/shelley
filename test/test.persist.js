...
(function() {
  var Backbone, LocalStorage, Point, StorageSync, delayed, unexpectedError,
  ...
  if (!window.localStorage) {
    window.localStorage = {
      ...
      getItem: function(name) {
        return window.localStorage._items[name];
      },
      setItem: function(name, value) {
        return window.localStorage._items[name] = value;
      },
      clear: function() {
        return window.localStorage._items = {};
      }
    };
  }
